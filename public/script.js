...
(function () {
  ...
  // --------------------------------------------------------
  // Force Scroll to Top on Reload (Prevention of Glitch)
  // --------------------------------------------------------
  ...
  function initScrollReveal() {
    ...
    // Target the PARENT TRIGGER and generic 'reveal-up' cards
    const elements = document.querySelectorAll('.reveal-trigger, .reveal-up');
